...
import com.example.medical.service.CustomUserDetailService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().cors().disable().authorizeRequests()
                .antMatchers("/", "/index", "/login", "/register", "/logout", "/plugins/**", "/dist/**",
                        "/appointment", "/assets/**", "/plugins/**", "/js/**", "/sendMessage", "/appointmentquery")
                .permitAll()
                ...
                .formLogin()
                .loginPage("/login")
                .defaultSuccessUrl("/proposals", true)
